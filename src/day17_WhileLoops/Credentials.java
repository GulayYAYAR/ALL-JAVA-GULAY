...
// System.exit(0), break, continue
    */
     ...
     boolean valid =username.equalsIgnoreCase("lale")&& password.equalsIgnoreCase("allam3");
     int con =1;
     while (!valid){

         System.out.println("Please re enter credentions");
         System.out.println("please enter username");
         username = input.next();
         System.out.println("please enter password");
         password=input.next();

         valid=username.equalsIgnoreCase("lale")&& password.equalsIgnoreCase("allam3");
