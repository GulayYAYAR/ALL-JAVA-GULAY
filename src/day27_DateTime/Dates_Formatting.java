...
public class Dates_Formatting {
    ...
    public static void main(String[] args) {
        ...
        DateTimeFormatter bor =DateTimeFormatter.ofPattern("EEEE dd MMMM yyyy");

        LocalDate mombirthday =LocalDate.of(1973, 01, 01);
        String ll=mombirthday.format(bor);
        System.out.println("Happy birthday MoM "+ll);
