...
public class UniqueValues {
    public static void main(String[] args) {
        ...
        String atlar[] = {"maral", "sona", "sulgun", "selbi", "sona", "selbi"};


        for (int i = 0; i < atlar.length; i++) { //atlan maral. sona, sulgun. selbi...


            int count = 0;
            for (int v = 0; v < atlar.length; v++) {
                if (atlar[i].equals(atlar[v])) {
                    count++;
